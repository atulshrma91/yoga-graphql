...
export type ResolversTypes = ResolversObject<{
  ...
  GenerateWalletSummary: ResolverTypeWrapper<Omit<GenerateWalletSummary, 'wallet'> & { wallet?: Maybe<ResolversTypes['WalletSummary']> }>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  GenerateWalletSummary: Omit<GenerateWalletSummary, 'wallet'> & { wallet?: Maybe<ResolversParentTypes['WalletSummary']> };
